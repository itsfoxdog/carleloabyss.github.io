...
const Cars = () => {
  const [bg, bgChange] = useState("bg-white");
  return (
    <div className="flex flex-wrap">
      {carData.map((value) => (
        <div
          className={`w-full md:w-1/2 lg:w-1/3 p-4 ${bg}`}
          // onMouseOver={() => {
          //   bgChange("bg-blue-500 cursor-pointer");
          // }}
        >
          <div className="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden flex flex-col ">
            <div className="flex-grow">
              ...
              <div className="p-6 flex flex-col">
                ...
                <p className="flex-grow leading-relaxed mb-3"></p>
